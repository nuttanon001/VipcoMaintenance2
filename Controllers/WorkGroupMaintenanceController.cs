...
namespace VipcoMaintenance.Controllers
{
    ...
    {
        public WorkGroupMaintenanceController(IRepositoryMaintenance<WorkGroupMaintenance> repo,
        ...
        public async Task<IActionResult> GetScroll([FromBody] ScrollViewModel Scroll)
        {
            ...
            var ListMapData = new List<WorkGroupMaintenanceViewModel>();
            foreach (var item in await QueryData.ToListAsync())
                ListMapData.Add(this.mapper.Map<WorkGroupMaintenance, WorkGroupMaintenanceViewModel>(item));
            return new JsonResult(new ScrollDataViewModel<WorkGroupMaintenanceViewModel>(Scroll, ListMapData
